...
$ind = 1;
$cores_botao = ["#f98a07", "#5dd11f", "#e4dc0d", "#ed3615"];
        ...
        $(document).load("http://localhost/horto_fenix/ajax_listas", { nome: $nome }, function(data){
                    ...
                    if($nome == " Jardim"){
                            ...
                            $(document).find(".nome_lista")
                                ...
                                .next()
                                .text("Escolha de A a Z as melhoras plantas para seus jardim:");
                            ...
                            $(document).find(".nome_lista")
                                ...
                                .next()
                                .text("Escolha de A a Z as melhoras plantas para Interiores:");
                            $(document).find(".lista").html(data);
                            $('.lista').tinyscrollbar();
                            ...
                            $(document).find(".nome_lista")
                                ...
                                .next()
                                .text("Escolha de A a Z as melhoras plantas e sementes para plantio:");
                            $(document).find(".lista").html(data);
                            $('.lista').tinyscrollbar();
                            ...
                            $(document).find(".nome_lista")
                                ...
                                .next()
                                .text("Escolha de A a Z as melhoras flores:");
                            $(document).find(".lista").html(data);
                            $('.lista').tinyscrollbar();
                            ...
                            $(document).find(".nome_lista")
                                ...
                                .next()
                                .text("Escolha de A a Z as melhoras Gramas par seu jardim:");
                            $(document).find(".lista").html(data);
                            $('.lista').tinyscrollbar();
