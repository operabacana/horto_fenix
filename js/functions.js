...
$(function(){
   ...
   /*$(document).find(".carrossel_imagens_mini img").click(function(){

       $ind = $(this).parent().index();
       $(document).find(".carrossel_imagens").jCarouselLite(event);
   ...
   $(document).find(".carrossel_projetos img").click(function(){
