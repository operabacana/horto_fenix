...
if ($_GET["id"] != "") {
    ...
    $sel = mysql_query("SELECT * FROM moveis WHERE id = '$id'");
...
<div id="article">
	...
	<h2><span>Móvel </span> &gt;&gt; Cadastrar</h2>

	<br />

    <?php if (isset($_GET["error"])) { if ($_GET["error"] == "new") { ?>
    <?php echo "<p class='warning_part'>Por favor adicione o nome do projeto.</p>"; ?>
    <?php } } ?>
    ...
    <div id="passo1">
        ...
        <table id="tableFotos" class="two">
            ...
            <form action="_editar.php" method="post" enctype="multipart/form-data">
                ...
                <tr><td style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Produto:&nbsp;&nbsp;<input type="text" name="produto" style="width: 247px;" /></td></tr>
                ...
                <tr><td><p style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Solução:</p>&nbsp;&nbsp;<textarea style="height: 50px;" name="solucao"></textarea></td></tr>
                 <tr><td><p style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Tipo:</p>&nbsp;&nbsp;<input type="checkbox" name="tipo[]" id="interno" value="1" />&nbsp;<label for="interno">Interno</label>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="tipo[]" id="externo" value="2" />&nbsp;<label for="externo">Externo</label></td></tr>
    ...
    <h2><span>Móvel </span> &gt;&gt; Editar</h2>

	<br />

    <?php if (isset($_GET["error"])) { if ($_GET["error"] == "new") { ?>
    <?php echo "<p class='warning_part'>Por favor coloque o nome do produto.</p>"; ?>
    <?php } } ?>
    ...
    <div id="passo2" style="background: #eeeeee; float: left; width: 100%;">
        ...
        <table id="tableFotos" class="two">
            ...
            <form action="_editar.php" method="post" enctype="multipart/form-data">
                ...
                <tr><td style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Produto:&nbsp;&nbsp;<input type="text" name="produto" style="width: 247px;" value="<?php echo $result["produto"]; ?>" /></td></tr>
                ...
                <tr><td><p style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Solução:</p>&nbsp;&nbsp;<textarea style="height: 50px;" name="solucao"><?php echo $result["solucao"]; ?></textarea></td></tr>
                 <tr><td><p style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Tipo:</p>&nbsp;&nbsp;<input type="checkbox" name="tipo" value="interno" /><label>Interno</label>&nbsp;&nbsp;&nbsp;<input type="checkbox" name="tipo" value="externo" /><label>Externo</label></td></tr>

                <tr class="trBlock">
                    <td>
                        <div style="width: 205px; float: left; margin-right: 10px; margin-bottom: 10px;">

                            <a href="../../fotos_moveis/G/<?php echo $result["foto_grande"]; ?>" title="Imagem ZOOM" class="highslide" onclick="return hs.expand(this)"><img src="../../fotos_moveis/P/<?php echo $result["foto_pequena"]; ?>" alt="Imagem com defeito" style="width: 205px; float: left;" /></a>
