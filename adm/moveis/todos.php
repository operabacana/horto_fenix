...
$sel = mysql_query("SELECT * FROM moveis");
$num = mysql_num_rows($sel);

?>

<?php open_header(); ?>
<title>Listar Paisagismo <?php echo $global_tittle; ?></title>
<?php close_header(); ?>
<?php get_header(); ?>
<?php get_sidebar(); ?>
...
<div id="article">
	...
	<h2><span>Paisagismo</span> &gt;&gt; Lista</h2>
    	    ...
    	    <td>
      	        ...
      	        <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr class="hover">
                        ...
                        <td><?php if( $result["tipo"] == 1 ){ echo "Interno"; }else if( $result["tipo"] == 2 ){ echo "Externo"; }else{ echo "Interno/Externo"; } ?></td>
                        ...
                        <td style="text-align:center;"><strong><a href="./cadastrar.php?id=<?php echo $result["id"]; ?>&passo=1" title="Editar o evento <?php echo $result["nome"]; ?>">[Editar]</a></strong></td>
                        <td style="text-align:center;"><a href="javascript:confirmation('_excluir.php?id=<?php echo $result["id"];?>','Voc&ecirc; realmente deseja excluir permanentemente o móvel <?php echo $result["nome"]; ?>?')" title="excluir o evento <?php echo $result["nome"]; ?>"><strong>x</strong></a></td>
                    </tr>
