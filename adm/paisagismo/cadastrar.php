...
<div id="article">
    ...
    <div id="passo1">
        ...
        <table id="tableFotos" class="two">
            ...
            <form action="_editar.php" method="post" enctype="multipart/form-data">
                ...
                <tr><td style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Projeto:&nbsp;&nbsp;<input type="text" name="projeto" style="width: 247px;" /></td></tr>
    ...
    <?php if (isset($_GET["error"])) { if ($_GET["error"] == "new") { ?>
    <?php echo "<p class='warning_part'>Por favor coloque o nome do projeto.</p>"; ?>
    <?php } } ?>
    ...
    <div id="passo2" style="background: #eeeeee; float: left; width: 100%;">
        ...
        <table id="tableFotos" class="two">
            ...
            <form action="_editar.php" method="post" enctype="multipart/form-data">
                ...
                <tr><td style="vertical-align: top; color: #999999; font-size: 14px; font-weight: bold;">Projeto:&nbsp;&nbsp;<input type="text" name="projeto" style="width: 247px;" value="<?php echo $result["projeto"]; ?>" /></td></tr>
