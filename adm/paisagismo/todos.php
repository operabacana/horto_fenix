...
$sel = mysql_query("SELECT * FROM paisagismo");
    	    ...
    	    <td>
      	        ...
      	        <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr class="hover">
                        ...
                        <td style="text-align:center;"><a href="javascript:confirmation('_excluir.php?id=<?php echo $result["id"];?>','Voc&ecirc; realmente deseja excluir permanentemente o evento <?php echo $result["nome"]; ?>?')" title="excluir o evento <?php echo $result["nome"]; ?>"><strong>x</strong></a></td>
                    </tr>
