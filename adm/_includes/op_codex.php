...
$ftp_pass = "132456"; //Senha do FTP (padrão: "")
...
//BANCO DE DADOS
$bd_dir = "192.168.0.50:3306"; //Local do Banco de Dados
$bd_login = "opera"; //Login do Banco de Dados
$bd_pass = ""; //Senha do Banco de Dados
$bd_select = "horto_fenix"; //Seleciona o Banco de Dados
...
$bds_dir = "192.168.0.50:3306"; //Local do Banco de Dados
$bds_login = "opera"; //Login do Banco de Dados
$bds_pass = ""; //Senha do Banco de Dados
$bds_select = "horto_fenix"; //Seleciona o Banco de Dados
