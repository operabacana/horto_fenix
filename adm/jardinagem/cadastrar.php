...
if ($_GET["id"] != "") {
    ...
    $sel = mysql_query("SELECT * FROM jardinagem WHERE id = '$id'");
...
<div id="article">
	...
	<h2><span>Jardinagem </span> &gt;&gt; Cadastrar</h2>
    ...
    <h2><span>Jardinagem </span> &gt;&gt; Editar</h2>
                ...
                <tr class="trBlock">
                    <td>
                        <div style="width: 205px; float: left; margin-right: 10px; margin-bottom: 10px;">
                            ...
                            <a href="../../fotos_jardinagem/G/<?php echo $result["foto_grande"]; ?>" title="Imagem ZOOM" class="highslide" onclick="return hs.expand(this)"><img src="../../fotos_jardinagem/P/<?php echo $result["foto_pequena"]; ?>" alt="Imagem com defeito" style="width: 205px; float: left;" /></a>
